        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('category_id', trans('quickadmin.faq-questions.fields.category').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('question_text', trans('quickadmin.faq-questions.fields.question-text').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('answer_text', trans('quickadmin.faq-questions.fields.answer-text').'*', ['class' => 'control-label']) !!}
